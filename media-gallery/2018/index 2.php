...
$customtitle = "GG 1.3 test build Jul 1st 2014";
...
echo '<head><title>' . $customtitle . '</title><meta http-equiv="Content-Type" content="text/html; charset=utf-8" />';
...
{
echo '<div id="bottomlink"><br/><a id="generated" onmouseup="displaylogin()">Generated</a> on-the-fly by <a href="http://lagbag.com/goodgallery">GoodGallery 1.3.unreleased</a></div>';
echo '</div>';
echo '</body>';
echo '</html>';
}
