...
{
	global $customtitle;
echo '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta http-equiv="X-UA-Compatible" content="ie=edge"><link rel="stylesheet" href="http://gatormotorsports.com/framework/css/bootstrap.min.css"><link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.3.1/css/all.css" integrity="sha384-mzrmE5qonljUremFsqc01SB46JvROS7bZs3IO2EmfFsd15uHvIt+Y8vEf7N7fWAU" crossorigin="anonymous"><link href="https://fonts.googleapis.com/css?family=Exo:600|Open+Sans" rel="stylesheet">';
echo '<link rel="stylesheet" href="http://gatormotorsports.com/css/main.css"><title>Gator Motorsports - Media - ' . $customtitle . '</title><link rel="apple-touch-icon" sizes="180x180" href="apple-touch-icon.png"><link rel="icon" type="image/png" sizes="32x32" href="favicon-32x32.png"><link rel="icon" type="image/png" sizes="16x16" href="favicon-16x16.png"><meta name="msapplication-TileColor" content="#da532c"><meta name="theme-color" content="#ffffff"></head>';
echo '<div class="social-media-menu"><div class="container"><ul><li><a href="https://www.facebook.com/gatormotorsports"><i class="fab fa-facebook-square"></i></a></li><li><a href="https://www.instagram.com/gator.motorsports/"><i class="fab fa-instagram"></i></a></li><li><a href="mailto:uffsae@gmail.com"><i class="fas fa-envelope"></i></a></li></ul></div></div><nav class="navbar navbar-expand-lg navbar-dark nav-alt" id="navbar"><div class="nav-container"><a class="navbar-brand" href="http://gatormotorsports.com/index.html">
<img alt=""class=logo src=http://gatormotorsports.com/img/logo.png> <button aria-controls=navbarSupportedContent aria-expanded=false aria-label="Toggle navigation"class=navbar-toggler data-target=#navbarSupportedContent data-toggle=collapse type=button><span class=navbar-toggler-icon></span></button><div class="collapse navbar-collapse"id=navbarSupportedContent><ul class="ml-auto navbar-nav"><li class=nav-item><a class=nav-link href=http://gatormotorsports.com/about.html>ABOUT</a><li class=nav-item><a class=nav-link href=http://gatormotorsports.com/media.html>MEDIA</a><li class=nav-item><a class=nav-link href=http://gatormotorsports.com/sponsors.html>SPONSORS</a><li class=nav-item><a class=nav-link href=http://gatormotorsports.com/join.html>JOIN</a></ul></div>';
echo '<div class=page-content-norm><div class="media-intro page-intro"><div class=page-title><h1>MEDIA</h1></div></div><div class=container><div class=content-p><div class=row>';
}

function htmlbottom() //please don't remove my link :)
{
echo '<footer><div class=content-p><div class=container><div class=row><div class=col><h6>Mailing Address</h6><p>Attn: Gator Motorsports<p>237 MAE-B<p>University of Florida<p>Gainesville, Florida 32611</div><div class=col><h6>Shipping Address</h6><p>Attn: Gator Motorsports<p>133-134 MAE-C<p>University of Florida<p>Gainesville, Florida 32611</div><div class=col><h6>Contact</h6><p>Phone: <a href=tel:5614278468>(561) 427-8468</a><p>Fax: (352) 392-1071<p>Email: <a href=mailto:uffsae@gmail.com>uffsae@gmail.com</a></div></div><div class=row><div class=col><hr><p class=copyright>Copyright © Gator Motorsports 2018</div></div></div></div></footer>
';
echo '</div>';
echo '<script src=https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js></script><script src=http://gatormotorsports.com/framework/js/bootstrap.min.js></script><script>window.onscroll=function(){myFunction()};var navbar=document.getElementById("navbar"),sticky=navbar.offsetTop;function myFunction(){window.pageYOffset>=sticky?navbar.classList.add("fixed-top"):navbar.classList.remove("fixed-top")}</script>';
echo '</body>';
echo '</html>';
}
...
function XHConn()
{
  ...
  return this;
	...
	<div id="prevnext">
	<button onmouseup="leftbutton()">Prev</button>
	<a href="$selfurl#:" onclick="displaythumbs(pnum);return false;"> Thumbnails </a>
	<button onmouseup="rightbutton()">Next</button>
	</div>
